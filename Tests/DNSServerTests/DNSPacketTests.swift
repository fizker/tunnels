...
struct DNSPacketTests {
	@Test
	func initWithIterator__validRequest__parsesAsExpected() throws {
		let input: [UInt32] = [
	...
	@Test
	func initWithIterator__validResponse__parsesAsExpected() throws {
		let input: [UInt32] = [
	...
	@Test
	func asData__validQuery_packetHaveOneQuestion__returnsExpectedBytes() throws {
		...
		#expect(expected == packet.asData)
	}

	@Test
	func asData__validResponse_packetHaveOneQuestionAndOneAnswer__returnsExpectedBytes_domainNameIsNotCompressed() throws {
		let packet = DNSPacket(
			header: .init(
				id: 0x862a,
				kind: .response,
	...
	@Test(.disabled("Data compression is not implemented."))
	func asData__validResponse_packetHaveOneQuestionAndOneAnswer__returnsExpectedBytes() throws {
		let packet = DNSPacket(
			header: .init(
				id: 0x862a,
				kind: .response,
