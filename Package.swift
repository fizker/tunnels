...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/fizker/swift-acme-client.git", from: "0.4.1"),
		...
		.package(url: "https://github.com/fizker/swift-oauth2-models.git", .upToNextMinor(from: "0.4.1")),
		.package(url: "https://github.com/fizker/swift-rotating-file-log-handler.git", .upToNextMinor(from: "0.4.0")),
	...
	targets: [
		...
		.target(
			...
			dependencies: [
				...
				.product(name: "FzkExtensions", package: "swift-extensions"),
				.product(name: "OAuth2Models", package: "swift-oauth2-models"),
				.product(name: "RotatingFileLogHandler", package: "swift-rotating-file-log-handler"),
				.product(name: "WebURL", package: "swift-url"),
				.product(name: "Vapor", package: "vapor"),
			],
			swiftSettings: upcomingFeatures
